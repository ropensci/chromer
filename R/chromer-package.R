...
#'
#' This package is a R based interface to the Chromosome Counts Database (CCDB). Currently, this consists of just one function \code{\link{chrom_counts}}, which queries the database using the taxa supplied.
#'
